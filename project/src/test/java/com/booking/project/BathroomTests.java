...
public class BathroomTests {
    ...
    void testGetAllBathrooms() {
        ...
        bathroomsResult.add(new Bathroom(1L, 2L, 1, true, true, "mare",
                "fier de calcat", true, true));
        bathroomsResult.add(new Bathroom(2L, 2L, 1, false, false, "mica",
                "matura", true, true));
    ...
    void testGetBathrooms() {
        Long id = 2L;
        List<Bathroom> bathroomsResult = new ArrayList<>();
        bathroomsResult.add(new Bathroom(1L, id, 1, true, true, "mare",
                "fier de calcat", true, true));
        bathroomsResult.add(new Bathroom(2L, id, 1, false, false, "mica",
                "matura", true, true));
        List<Bathroom> bathroomsToBeReturned = new ArrayList<>(bathroomsResult);
    ...
    void testCreateBathroom() {
        Bathroom bathroom = new Bathroom(1L, 2L, 1, true, true, "mare",
                "fier de calcat", true, true);
    ...
    void testDeleteBathroom() {
        Long id = 1L;
        Bathroom bathroom = new Bathroom(1L, id, 1, true, true, "mare",
                "fier de calcat", true, true);
    ...
    void testUpdateBathroom() {
        Long id = 1L;
        Bathroom bathroomToBeUpdated = new Bathroom(1L, id, 1, true, true, "mare",
                "fier de calcat", true, true);
        Bathroom newBathroom = new Bathroom(2L, 2L, 1, false, false, "mica",
                "matura", true, true);
